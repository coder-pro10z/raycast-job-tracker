      ...
      if (cached) {
        try {
          ...
          if (Array.isArray(list) && list.length > 0) {
            // Auto-upgrade any legacy automator samples for Praveen (e.g. HashiCorp DevOps -> SDE & FSD)
            const upgraded = list.map(j => {
              if (userId === 'user_praveen' && j.companyName === 'HashiCorp' && (j.targetRole?.includes('DevOps') || j.outreachSubject?.includes('Candidate Introduction'))) {
                return {
                  ...j,
    ...
    if (!userId) {
      ...
      jobs.unshift(
        createAutomatorSeed({
          ...
          outreachSubject: 'Senior Full Stack Engineer Application – Praveen Kashyap',
          outreachBodyPreview: 'Hi Team, I noticed your opening for a Senior Full Stack Engineer. With 5+ years specializing in distributed systems, C# .NET, and React micro-frontends...',
        ...
        createAutomatorSeed({
          ...
          outreachSubject: 'Senior Full Stack Engineer Application – Praveen Kashyap',
          outreachBodyPreview: 'Hello Datadog Recruiting Team, Having architected high-performance web microservices in React and robust distributed backend APIs with 5+ years experience...',
        ...
        createAutomatorSeed({
          ...
          automatorStatus: 'Draft Created',
          outreachSubject: 'Senior Full Stack Engineer Application – Praveen Kashyap',
          outreachBodyPreview: 'Hi HashiCorp Team, With 5+ years hands-on experience in Full Stack development, modern React micro-frontends, high-performance Go/C# distributed backends, and cloud-native workflows, I would love to contribute to HashiCorp products...',
          appliedDate: new Date().toISOString().slice(0, 10),
          notes: 'Auto-generated by Claude for Praveen Kashyap (SDE & Full Stack).'
        })
      );
